...
static void clear(uint32 (*buf)[B32])
{
  int i;
  int j;
...
static void doit4(uint32 *a,long x,long y,int64 start)
{
  long i0;
  long y0;
  long i;
...
static void doit6(uint32 *a,long x,long y,int64 start)
{
  long i0;
  long y0;
  long i;
...
static void doit12(uint32 *a,long x,long y,int64 start)
{
  long i0;
  long y0;
  long i;
...
static void squarefree1(uint32 (*buf)[B32],uint64 L,uint32 q)
{
  uint32 qq;
  uint32 qqhigh;
  uint32 i;
...
static void squarefree49(uint32 (*buf)[B32],uint64 L,uint32 q)
{
  uint32 qq;
  uint32 qqhigh;
  uint32 i;
...
static void squarefreetiny(uint32 *a,uint32 *Lmodqq,int d)
{
  int j;
  uint32 k;
  uint32 qq;
